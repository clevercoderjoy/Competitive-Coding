...
# We need to divide the weight of the watermelon in such a way that the result is an even number.
# If the result will be an even number then the two parts of the divided watermelon will be even which is what we want.
# We need to return "Yes" if the weight of watermelon on dividing gives an even number else we need to print "No".
